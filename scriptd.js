const texts = [
    "Snusdosan (lek)", "Ellen har kavaj", "Ska avsluta det med Jonathan...", "Chark",
    "Vatten på innergården...", "Ellen utbringar skål", "Disneydansen", "Shotgun med Ellen",
    "Ellen bjuder på shot", "Uttalar något fel", "Shotvideo", "Ska söka jobb i Stockholm...",
    "Spelar rygg mot rygg", "Ska ge Jonathan en chans till...", "Ellen-selfie", "Spelare läcker bingon",
  ];
